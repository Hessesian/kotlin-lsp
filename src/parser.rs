...
use crate::queries::{
    ...
    KIND_INTERFACE_DECL, KIND_LAMBDA_LIT, KIND_METHOD_DECL, KIND_MODIFIERS, KIND_NAV_EXPR,
    KIND_OBJECT_DECL, KIND_PACKAGE_DECL, KIND_PROP_DECL, KIND_PROP_DELEGATE, KIND_PROTOCOL_DECL,
    KIND_RECORD_DECL, KIND_SCOPED_IDENT, KIND_SIMPLE_IDENT, KIND_STATEMENTS, KIND_SUPERCLASS,
    KIND_SUPER_INTERFACES, KIND_TYPE_IDENT, KIND_USER_TYPE, KIND_VALUE_ARG, KIND_VALUE_ARGS,
    KIND_VAR_DECL, KIND_VAR_DECLARATOR, KOTLIN_DEFINITIONS, SWIFT_DEFINITIONS,
};
use crate::StrExt;
